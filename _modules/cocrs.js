...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-1tc21xz");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1tc21xz");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-1tc21xz");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-1tc21xz");
			attr(nav, "class", "svelte-1tc21xz");
			attr(div0, "class", "desktop-nav svelte-1tc21xz");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-1tc21xz");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-1tc21xz");
			attr(header, "class", "section-container svelte-1tc21xz");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ('adtfe' in $$props) $$invalidate(3, adtfe = $$props.adtfe);
		if ('vjbzi' in $$props) $$invalidate(4, vjbzi = $$props.vjbzi);
		if ('logo' in $$props) $$invalidate(0, logo = $$props.logo);
		if ('site_nav' in $$props) $$invalidate(1, site_nav = $$props.site_nav);
	};

	return [logo, site_nav, mobileNavOpen, adtfe, vjbzi, click_handler, click_handler_1];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { adtfe: 3, vjbzi: 4, logo: 0, site_nav: 1 });
	}
}
